...
//           : "bg-gradient-to-br from-violet-100 via-white to-purple-200 text-gray-800"
//       }`}
//     >
...
//               Gestiona tus contactos de manera sencilla.
//             </p>
//           </div>
...
//             className="w-full border border-gray-300 rounded-lg p-3 shadow-sm focus:ring-2 focus:ring-purple-500 outline-none"
//           />
//         </div>
...
//             ))
//           ) : (
//             <div className="col-span-full text-center bg-white rounded-xl shadow p-8">
//               <h3 className="text-xl font-semibold text-gray-600">
//                 No hay contactos
//               </h3>
//               <p className="text-gray-500 mt-2">
//                 Agrega uno nuevo o cambia la búsqueda.
//               </p>
//             </div>
//           )}
//         </section>
...
// (Normalmente esto iría en tu tailwind.config.js, pero lo pongo aquí para facilitar copiar y pegar)
...
export default function App() {
  ...
  const [busqueda, setBusqueda] = useState("");
  const [usuario, setUsuario] = useState("");
  // Usaremos el estado 'tema' para alternar entre color Neón Púrpura (false) y Cian (true)
  ...
  // Selección dinámica de clases basadas en el estado del color
  ...
  return (
    // Fondo base ultra oscuro (Slate 950) y texto base gris claro
